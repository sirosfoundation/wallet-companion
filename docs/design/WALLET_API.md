...
The Wallet Companion extension provides a JavaScript API that allows digital identity wallets to automatically detect the extension and register themselves with the user's browser. This enables seamless integration without requiring users to manually configure wallet endpoints.
